"""
Integrated Financial Analysis System
Combines menu-driven services with LinkedIn article generation using judge-critic pattern.

# Usage:
python project_assignment_08.py
"""
...
# Function Tools for Financial Analysis (from project_assignment_06.py)
@function_tool
...
# Data Models (from project_assignment_07.py)
...
# Report Discovery and Parsing Functions (from project_assignment_07.py)
...
# Agents (from project_assignment_06.py)
...
# Agents (from project_assignment_07.py)
...
# Menu and Utility Functions (from project_assignment_06.py)
def display_menu():
    ...
    print("3. LinkedIn Article Generation (Create 220-word article from latest comparison)")
    print("4. Exit")
    print("="*60)
...
# Service Functions (from project_assignment_06.py)
...
# LinkedIn Article Generation Function (from project_assignment_07.py)
...
async def main():
    """Main application loop with integrated services"""
    while True:
        choice = display_menu()
